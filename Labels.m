...
[*
  ...
  <"2.2.12.1-578.1-d", [[ -17, 17 ]], 4, [<"2.1",  1*4>], x^4 + 10*x^3 + 20*x^2 - 25*x - 25>, // twist of 2.2.12.1-578.1-c
  ...
  <"2.2.12.1-722.1-k", [[ -19, 19 ]], 4, [<"2.1",  1*4>, <"25.1", -1*4>], x^4 + 9*x^3 + 26*x^2 + 24*x + 1>, // twist of 2.2.12.1-722.1-i
  <"2.2.12.1-722.1-l", [[ -19, 19 ]], 4, [<"2.1", -1*4>, <"25.1", -5*4>], x^4 + x^3 - 32*x^2 + 2*x + 149>, // twist of 2.2.12.1-722.1-k
  ...
  <"2.2.12.1-1587.1-m", [[0, -23]], 4, [<"2.1", -6>, <"3.1",  1*4>, <"23.1", -1*4>], x^4 + 4*x^3 - 9*x^2 - 26*x + 31>, // mod 2 equals 2.2.12.1-1587.1-l
  <"2.2.12.1-1587.1-n", [[0, -23]], 4, [<"2.1", 2>, <"3.1", -1*4>, <"23.1", -1*4>], x^4 + 3*x^3 - 30*x^2 - 64*x + 179>, // mod 2 equals 2.2.12.1-1587.1-i
  ...
  <"2.2.8.1-2601.1-k", [[51,0]], 4, [<"9.1", -1*4>], x^4 - 4*x^3 - 14*x^2 + 51*x + 11>, //involution of 2.2.8.1-2601.1-j???
  <"2.2.8.1-2738.1-e", [[0,37]], 4, [<"2.1", 1*4>], x^4 + 3*x^3 - 6*x^2 - 18*x + 1>,
  <"2.2.8.1-2738.1-f", [[0,37]], 4, [<"2.1", -1*4>], x^4 + 3*x^3 - 4*x - 1>, // involution of 2.2.8.1-2738.1-e????
  <"2.2.5.1-31.2-a", [[ -3, 5 ]], 1, [<"4.1", -3*1>], x-1>,
  <"2.2.24.1-726.1-i", [[726, 0], [66, 0], [0,-11]], 4, [<"2.1", 1*4>, <"49.1", 5*4>], x^4 + 6*x^3 + 6*x^2 - 9*x - 9>,
  <"2.2.24.1-726.1-j", [[726, 0], [66, 0], [0,-11]], 4, [<"2.1", -1*4>, <"49.1", 5*4>], x^4 - 6*x^3 + 6*x^2 + 9*x - 9>,
  <"2.2.24.1-726.1-k", [[726, 0], [66, 0], [0,-11]], 4, [<"2.1", 1*4>,  <"49.1", -16>], x^4 - 2*x^3 - 8*x^2 + 9*x + 13>,
  <"2.2.24.1-726.1-l", [[726, 0], [66, 0], [0,-11]], 4, [<"2.1", -1*4>, <"49.1", -16>], x^4 + 2*x^3 - 8*x^2 - 9*x + 13>
*];
